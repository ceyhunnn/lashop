...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{route('nedmin.Index')}}" class="logo">
            ...
            <span class="logo-mini"><b>DS</b>hop</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>DS</b>hop</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('nedmin.Logout')}}" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i>Çıkış</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{route('product.index')}}"><i>DS</i> <span>Product</span></a></li>
                <li><a href="{{route('blog.index')}}"><i class="fa fa-paper-plane"></i> <span>Blog</span></a></li>
                <li><a href="{{route('page.index')}}"><i class="fa fa-newspaper-o"></i> <span>Page</span></a></li>
                <li><a href="{{route('slider.index')}}"><i class="fa fa-exchange"></i> <span>Slider</span></a></li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">Ceyhun Muradov</a></strong> | All rights reserved.
    </footer>
