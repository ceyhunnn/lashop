                ...
                <table class="table table-striped">
                    ...
                    @foreach($data['product'] as $product)
                        <tr id="item-{{$product->id}}">
                            <td class="sortable" width="150"><img width="150" src="/images/products/{{$product->product_file}}" alt=""></td>
                            <td >{{$product['product_title']}}</td>
                            <td width="5"><a href="{{route('product.edit',$product->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                            <td width="5">
