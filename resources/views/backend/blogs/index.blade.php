            ...
            <div class="box-body">
                <table class="table table-striped">
                    ...
                    @foreach($data['blog'] as $blog)
                        <tr id="item-{{$blog->id}}">
                            <td class="sortable" width="150"><img width="130" src="/images/blogs/{{$blog->blog_file}}" alt=""></td>
                            <td width="120">{{$blog['blog_title']}}</td>
                            <td width="200">{!!substr($blog->blog_content,0,100)!!}.....</td>
