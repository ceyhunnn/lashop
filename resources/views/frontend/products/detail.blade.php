        ...
        <div class="aa-product-details-area">
                ...
                <div class="aa-product-view-slider">
                  <div id="demo-1" class="simpleLens-gallery-container">
                    <div class="simpleLens-container">
                      <div class="simpleLens-big-image-container"><a data-lens-image="/images/products/{{$product->product_file}}" class="simpleLens-lens-image"><img src="/images/products/{{$product->product_file}}" class="simpleLens-big-image"></a></div>
                    </div>
              ...
              <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="aa-product-view-content">
                  ...
                  <div class="aa-price-block">
                    <span class="aa-product-view-price">{{$product->product_cost}}</span>
                  </div>
                  ...
                  <div class="aa-prod-quantity">
                    ...
                    <p class="aa-prod-category">
                      Category: <a href="#">{{$product->product_category}}</a>
                    </p>
                  </div>
          ...
          <div class="aa-product-related-item">
            ...
            <ul class="aa-product-catg aa-related-item-slider">
              ...
              <li>
                <figure>
                  <a class="aa-product-img" href="{{route('product.Detail',['id' => $list->id])}}"><img height="320px" width="550px" src="/images/products/{{$list->product_file}}" alt="polo shirt img"></a>
                  <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                   <figcaption>
                    <h4 class="aa-product-title"><a href="{{route('product.Detail',['id' => $list->id])}}">{{$list->product_title}}</a></h4>
                    <span class="aa-product-price">{{$list->product_cost}}</span>
                  </figcaption>
                </figure>
                ...
                <!-- product badge -->
                @if(strlen($list->product_sale)>0)
                <span class="aa-badge aa-sale" href="#">{{$list->product_sale}}</span>
                @endif
              </li>
              @endif
              @endforeach
