            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li><a href="" data-toggle="modal" data-target="#signout"></a></li>
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{route('home.Index')}}">
                  ...
                  <p>DS<strong>hop</strong> <span>Your Shopping Partner</span></p>
                </a>
                <!-- img based logo -->
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="{{route('product.Index')}}"><span>DS</span> Products</a></li>
              <li><a href="{{route('blog.Index')}}"><i class="fa fa-newspaper-o"></i> Blogs</a></li>
              <li><a href="#">Pages</a></li>
              <li><a href="{{route('home.Contact')}}"><i class="fa fa-envelope"></i> Contact</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
              ...
              <div class="aa-footer-widget">
                <div class="aa-footer-widget">
                  ...
                  <address>
                    <p> {{$adres}}</p>
                    <p><span class="fa fa-phone"></span>{{$phone}}</p>
                    <p><span class="fa fa-envelope"></span>{{$mail}}</p>
                  </address>
  ...
  <div class="container">
    ...
    <div class="col-md-12">
      <div class="aa-footer-bottom-area">
        <p>Copyright &copy; <a href="#">Ceyhun Muradov</a></p>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      <h4>Login</h4>
      <form class="aa-login-form" method="post" action="{{route('home.Authenticate')}}">
        @CSRF
        ...
        <label for="rememberme" class="rememberme"><input type="checkbox" name="remember_me" {{old('remember_me') ? 'checked' : ""}} id="rememberme"> Remember me </label>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      <h4>Register</h4>
      <form class="aa-login-form" method="post" action="{{route('user.Create')}}">
        @CSRF
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      ...
      <br>
      <div align="right">
          <a href="{{route('home.Logout')}}" class="btn btn-danger"><i class="fa fa-sign-out"></i> Logout</a>
      </div>
